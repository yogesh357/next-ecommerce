    ...
    return (
        <header className='flex flex-wrap justify-between items-center px-4 py-2'>
            ...
            <div className='flex w-full flex-wrap justify-between items-center '>
                <Link href="/"
                    className='text-2xl text-blue-500 hover:opacity-50 cursor-pointer mx-auto sm:mx-0'
                >
                    Shopr
                </Link>
                <Form action={'/search'}
                ...
                <div className='flex items-center space-x-4 mt-4 sm:mt-0 flex-1 sm:flex-none'>
                    <Link
                        ...
                        <span className='absolute -top-2 -right-5 bg-red-500 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs'>{itemCount}</span>
                        <span>My Basket</span>
                    </Link>
                    ...
                    <ClerkLoaded>
                        ...
                        {user?.passkeys.length === 0 && (
                            <button
                                ...
                                className='bg-white hover:bg-blue-700 hover:text-white transition text-blue-500   font-bold py-2 px-4 rounded border-b-blue-300 border'>
                                Create a passkey
                            </button>
                        )}
                    </ClerkLoaded>
